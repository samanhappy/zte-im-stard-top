...
<body>
    ...
    <div id="framePage">
        <div id="pageWrap">
        	<form id="workBenchForm" action="${pageContext.request.contextPath}/saveWorkImg.do">
        		<input type="hidden" name="imgList" id="imgList">
        	</form>
            <div class="workBenchWrap">
            	<div class="workBenchBox">
            		<ul class="sortable" id="workBenchList">
            		</ul>
            	</div>
            	<div class="workBenchOpt">
            		...
            		<div class="fr workBenchBtn">
            			<a href="javascript:;" class="workBenchSaveBtn" id="saveBtn" title="保存">保存</a>
            			<a href="javascript:;" class="disEditBtn" id="editBtn" title="编辑">编辑</a>
            		</div>
            	</div>
            </div>
        </div>
    </div>
    <script>seajs.use("page/enterprise_workBench_edit");</script>
</body>
</html>