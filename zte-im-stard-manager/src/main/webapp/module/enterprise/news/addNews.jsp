...
<body>
			...
			<div id="pageWrap">
				...
				<ul class="newsAddForm add">
					<li><label class="fTitle">标题:</label>
						...
						<div class="fr">
							<label><input type="radio" name="news_type" value="0"
								checked>&nbsp;普通新闻</label> <label><input type="radio"
								name="news_type" value="1">&nbsp;封面新闻</label>
						</div></li>
					...
					<li><label class="fTitle">&nbsp;</label>
						<div class="btns">
							<a href="javascript:" id="release" title="发布" class="release">发布</a>
							<a href="list.jsp" title="取消" class="cancel">取消</a> <a
	...
	<script>
		seajs.use("page/enterprise_news_addNews");
	</script>
</body>
</html>
