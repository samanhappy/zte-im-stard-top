	...
	<div class="selectPersonnel">
		...
		<div class="selectPersonnelDataList">
	        <table>
	            <thead>
	                <tr>
	                    <th width="30"><input id="checkAll" name="checkAll" type="checkbox" class="checkbox"></th>
	                    <th>姓名<em id="nameSort"><a href="javascript:;" class="asc"></a></em></th>
	                    <th>工号<em id="numSort"><a href="javascript:;" class="normal"></a></em></th>
	                    <th>部门<em id="deptSort"><a href="javascript:;" class="normal"></a></em></th>
	                </tr>
	            </thead>
...
<script>seajs.use("page/structure_selectPersonnel");</script>
</body>
</html>
