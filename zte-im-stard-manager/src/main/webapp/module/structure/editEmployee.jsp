...
<body>
	...
	<form id="editEmployeeForm" action="${pageContext.request.contextPath}/addUser.do">
			...
			<div class="employeeBd">
				...
				<div class="employeeContent">
					...
					<div class="formitm">
						...
						<div class="ipt" id="openDept">
							<i class="f"></i> <input id="deptName" name="deptName" type="text" readonly="readonly" class="txt"> <input
								id="deptId" name="deptId" type="hidden" value=""> <input id="deptRelationId" name="deptRelationId"
								type="hidden" value=""> <input id="deptTId" type="hidden" value="">
					...
					<div class="formitm">
						...
						<div class="ipt">
							<i class="f"></i> <select id="pos" name="pos" style="width: 210px;">
							</select> <input id="posDisplay" name="posDisplay" type="hidden" value=""> <input id="roleRelationId"
								name="roleRelationId" type="hidden" value=""> <i class="e"></i>
						</div>
					</div>
					<div class="formitm">
					...
					<div class="formitm">
						...
						<div class="ipt">
							<i class="f"></i> <input type="password" id="password" name="password" class="txt" autocomplete="off"> <i
								class="e"></i>
						</div>
					</div>
				</div>
		...
		<div class="dialogBtns">
			<a href="javascript:;" class="delDept" id="dialogDelBtn">删除员工</a> <a href="javascript:;" class="add"
				id="dialogAddBtn">保存</a> <a href="javascript:;" class="cancel" id="dialogCancelBtn">取消</a>
		</div>
	</form>
	<script>
		seajs.use("page/structure_editEmployee");
	</script>
</body>
</html>
