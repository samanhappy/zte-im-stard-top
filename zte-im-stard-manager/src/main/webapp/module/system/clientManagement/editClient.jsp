...
<body>
	...
	<form id="editClientForm" action="${pageContext.request.contextPath}/editClient.do">
			...
			<div class="clientFormWrap addFieldBd">
						...
						<li class='android'><span class="lab">图标:</span>
							<div class="ipt">
								<a href="javascript:;" class="uploadPic" title="上传图标"> <input id="ciconUrl" name="ciconUrl" type="hidden" />
									<img id="cicon" name="cicon" src="${pageContext.request.contextPath}/appPic/appIco.jpg" height="43" width="43" /></a>
							</div></li>
				...
				<div class="fr">
					<ul>
						...
						<li>是否立即更新当前版本： <label><input type="radio" type="checkbox" id="cyActive" name="cisActive" value="on">是</label>
		...
		<div class="dialogBtns">
			<a href="javascript:;" class="cancel" id="dialogAddBtn">确定</a> <a href="javascript:;" class="cancel" id="dialogCancelBtn">取消</a>
		</div>
	</form>
	<script>
		seajs.use("page/system_clientManagement_editClient");
	</script>
</body>
</html>
