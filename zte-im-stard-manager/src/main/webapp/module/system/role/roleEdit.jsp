...
<body>
		...
		<div id="pageWrap">
			<div class="toolBar">
				<div class="fl barLink">
					<span class="disable">添加角色&nbsp;<i class="iconfont">&#xe614;</i><a></a></span>
					<a href="javascript:;" title="编辑角色">编辑角色<i class="iconfont">&#xe613;</i></a>
					<a href="javascript:;" title="删除角色" id="delRoleBtn">删除角色<i
						class="iconfont">&#xe60e;</i></a>
				</div>
			</div>
	...
	<script>
		seajs.use("page/system_role_roleEdit");
	</script>
</body>
</html>