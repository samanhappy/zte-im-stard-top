...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String editablePropVals = request.getParameter("editablePropVals");
%>
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	...
	<input type="hidden" id="editablePropVals"
		value="<%=editablePropVals%>">
	<div class="dialogBd">
		<ul class="memberPropertiesSettingBd" id="addressBookSettingList">
		</ul>
	</div>
	...
	<script>
		seajs.use("page/system_setting_addressBookSetting");
	</script>
</body>
</html>
