define(function(require,exports,module){
    ...
    $("#checkAll").live("click",function(){
        if ($("#checkAll").is(':checked')) {
            $("#structureSelectPersonnelList input[type='checkbox']").each(function() {
                this.checked = true;
            });
        } else {
            $("#structureSelectPersonnelList input[type='checkbox']").each(function() {
    ...
    $('#dialogDeptConfirm').on('click', function(){
		...
		$(window.parent.frames[iframeId].document).find("#visiblePersonnel").html(perms);
		$(window.parent.frames[iframeId].document).find("#userPermDiv").html(divPerms);
