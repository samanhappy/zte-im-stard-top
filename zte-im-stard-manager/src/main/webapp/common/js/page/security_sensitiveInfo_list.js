define(function(require,exports,module){
    ...
    function recordList(){
    	$.ajax({
            url:webPath + "json/recordList.json",
            type: 'post',
                    ...
                    require.async(['pager/pager.css','pager/pager'],function(){
                        kkpager.generPageHtml({
                                ...
                                click:function(n,total,totalRecords){
                                    $.ajax({
                                        type:"get",
                                        url:webPath + "json/recordList.json?randomTime=" + (new Date()).getTime()+"&cPage="+n,
    ...
    $('#exportRecordBtn').on('click', function(){   	
    	top.$.layer({
            ...
            move: false,
            fix: true,
            iframe: {src: 'module/security/sensitiveInfo/export.jsp'}
        });
    });
