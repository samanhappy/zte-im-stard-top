...
public class EncryptionDecryption {
	...
	private static String strDefaultKey = "surfdesk_!@#";
	 ...
	 * @throws Exception
	 */
	public String encrypt(Long strIn) throws Exception {
		String str = Long.toString(strIn);
	...
	public String decrypt(String strIn) throws Exception {
		if (strIn != null && !"".equalsIgnoreCase(strIn)) {
			try {
