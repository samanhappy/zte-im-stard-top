...
<div class="loginWrap">
	...
	<div class="loginBd">
		<form id="login" action="${pageContext.request.contextPath}/json/forgetPwd.json" method="post" autocomplete="off">
			<ul>
				<li class="userName"><input type="text" name="name" id="name" placeholder="账   号" autocomplete="off"></li>
				<li class="userMail"><input type="text" name="email" id="email" placeholder="邮   箱" autocomplete="off"></li>
				<li class="loginTipMsg"><em></em></li>
				<li><a href="${pageContext.request.contextPath}/login.jsp" class="back">返回登录</a><input type="submit" value="确&nbsp;&nbsp;定" class="confirmBtn"></li>
			</ul>
		</form>
	</div>
</div>
