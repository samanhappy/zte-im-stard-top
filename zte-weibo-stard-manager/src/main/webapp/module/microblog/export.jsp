...
<input type="hidden" id="twitterId" value="${param.twitterId}">
<div class="dialogBd">
	<div class="accountOpenWrap">
		<p id = "all">确定导出公司全部分享？</p>
		<p id="notAll" style="display:none;">确定导出选中的${param.num }条分享吗？</p>
	</div>
</div>
...
<script>seajs.use("page/microblog_export");</script>
</body>
</html>
