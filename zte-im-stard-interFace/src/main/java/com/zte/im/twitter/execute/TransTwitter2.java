 ...
 *
 */
public class TransTwitter2 extends AbstractValidatoExecute {

	private static Logger logger = LoggerFactory.getLogger(TransTwitter2.class);
	...
	public String doProcess(JSONObject json) {
		...
		try {
			...
			if (t != null && "00".equals(t.getTwitterStatus()) ) {
				...
				List<Map<String, Object>> deptlist2 = JSON.parseObject(json.getString("deptList"),
						new TypeReference<List<Map<String, Object>>>() {
				});
				List<Map<String, Object>> stafflist2 = JSON.parseObject(json.getString("staffList"),
                        new TypeReference<List<Map<String, Object>>>() {
                });
	...
	public static void main(String[] args) {
		...
		AbstractValidatoExecute e = new TransTwitter2();
