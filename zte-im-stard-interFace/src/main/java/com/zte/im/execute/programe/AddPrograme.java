 ...
 * 
 */
public class AddPrograme extends AbstractValidatoExecute {
	
	private static Logger logger = LoggerFactory.getLogger(AddPrograme.class);
	...
	public String doProcess(JSONObject json) {
		...
		try {
			...
			ProgrameServiceImpl.getInstance().addPrograme(programe);
	...
	public static void main(String[] args) throws ParseException {
		...
		json.put("uid", 1l);
		json.put("title", "买菜5");
		json.put("progStartDate", "20141105");
		json.put("progStartTime", "02:00");
		json.put("progEndDate", "20141108");
		...
		AbstractValidatoExecute e = new AddPrograme();
