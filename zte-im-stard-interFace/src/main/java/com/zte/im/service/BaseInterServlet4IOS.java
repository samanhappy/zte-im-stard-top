...
@WebServlet(urlPatterns = "/zteim4ios", asyncSupported = false, loadOnStartup = 1)
public class BaseInterServlet4IOS extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
		...
		ResponseSender.sendResponse(response, resultJson.getBytes("utf-8"), "utf-8", null);
	}
